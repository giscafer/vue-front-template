...
/**
 * 将对象排除 undefined 和 空字符串属性；使用场景如有枚举，传null的情况，不能穿空字符串
 * @param {Object} obj
 */
export const pickValidVal = obj => {
 ...
 * @param {String} url
 */
export const clearUrlSlash = (url = '') => {
  return url.replace(/\/\//g, '/');
};

export const uuidStr = (len = 12) => {
  return Math.random()
    .toString(16)
    .substr(2, len);
};
